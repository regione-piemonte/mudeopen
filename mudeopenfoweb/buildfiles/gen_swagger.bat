...
java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\mudeopenfoweb.yaml -l jaxrs-resteasy-eap-csi -o .. --config swagger_config_java.json
...
rem java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\mudeopenfoweb.yaml -l typescript-angular -o ..\..\mudeopenfobeapi --config swagger_config_angular.json 
...
rem java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\mudeopenfoweb.yaml -l java -o ..\..\mudeopenfobeapi --config swagger_config_java.json