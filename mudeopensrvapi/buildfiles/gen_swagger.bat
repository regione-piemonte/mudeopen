...
java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\mudeopensrvapi.yaml -l jaxrs-resteasy-eap-csi -o .. --config swagger_config_java.json
...
rem java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\mudeopensrvapi.yaml -l typescript-angular -o ..\..\mudeopenapiapi --config swagger_config_angular.json 
...
rem java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\mudeopensrvapi.yaml -l java -o ..\..\mudeopenapiapi --config swagger_config_java.json