...
java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\mudeopenboweb.yaml -l jaxrs-resteasy-eap-csi -o .. --config swagger_config_java.json
...
rem java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\mudeopenboweb.yaml -l typescript-angular -o ..\..\mudeopenbobeapi --config swagger_config_angular.json 
...
rem java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\mudeopenboweb.yaml -l java -o ..\..\mudeopenbobeapi --config swagger_config_java.json