...
@Component
public class SpeciePraticaEntityMapperImpl implements SpeciePraticaEntityMapper {
    @Override
    public DizionarioVO mapEntityToVO(MudeDSpeciePratica dto) {
        if (dto == null)
            return null;
    ...
    @Override
    public List<DizionarioVO> mapListEntityToListVO(List<MudeDSpeciePratica> tl) {
        return SpeciePraticaEntityMapper.super.mapListEntityToListVO(tl);
    }
}