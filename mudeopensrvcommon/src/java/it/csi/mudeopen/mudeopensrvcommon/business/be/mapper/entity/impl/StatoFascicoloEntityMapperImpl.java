...
@Component
public class StatoFascicoloEntityMapperImpl implements StatoFascicoloEntityMapper {
    @Override
    public DizionarioVO mapEntityToVO(MudeDStatoFascicolo dto) {
        if (dto == null)
            return null;
    ...
    @Override
    public List<DizionarioVO> mapListEntityToListVO(List<MudeDStatoFascicolo> tl) {
        return StatoFascicoloEntityMapper.super.mapListEntityToListVO(tl);
    }
}