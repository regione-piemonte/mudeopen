...
@Component
public class TipoInterventoEntityMapperImpl implements TipoInterventoEntityMapper {
    @Override
    public DizionarioVO mapEntityToVO(MudeDTipoIntervento dto) {
        if (dto == null)
            return null;
    ...
    @Override
    public List<DizionarioVO> mapListEntityToListVO(List<MudeDTipoIntervento> tl) {
        return TipoInterventoEntityMapper.super.mapListEntityToListVO(tl);
    }
}