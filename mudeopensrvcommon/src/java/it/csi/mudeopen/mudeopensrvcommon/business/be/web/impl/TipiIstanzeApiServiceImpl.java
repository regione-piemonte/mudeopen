...
import it.csi.mudeopen.mudeopensrvcommon.business.be.web.TipiIstanzeApi;
import it.csi.mudeopen.mudeopensrvcommon.util.AbstractApi;

@Component
public class TipiIstanzeApiServiceImpl extends AbstractApi implements TipiIstanzeApi {
