...
public class RegimeAggiuntivoVO extends ParentVO {
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof RegimeAggiuntivoVO))
			return false;
		RegimeAggiuntivoVO other = (RegimeAggiuntivoVO) obj;
	...
	public String toString() {
		...
		builder.append("RegimeAggiuntivoVO\n [idRegime=").append(idRegime).append("\n denominazione=")
