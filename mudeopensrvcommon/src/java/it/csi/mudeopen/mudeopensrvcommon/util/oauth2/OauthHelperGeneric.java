...
public class OauthHelperGeneric {

	static String classTag = "COSMO";
	static Logger logger = Logger.getLogger(OauthHelperGeneric.class.getCanonicalName());
	...
	public OauthHelperGeneric(String oauthURL, String consumerKey, String consumerSecret, int timeout, boolean isTokenCacheEnabled) {
    ...
    private String getTokenInternal() {
		...
		logger.info("[OauthHelperCosmo.getTokenInternal]\n" + 
			        "oauthURL ........: " + oauthURL + "\n" +
