...
public class OauthHelperSigmater {

	static String classTag = "SIGMATER";
	static Logger logger = Logger.getLogger(OauthHelperSigmater.class.getCanonicalName());
	...
	public OauthHelperSigmater(String oauthURL, String consumerKey, String consumerSecret, int timeout, boolean isTokenCacheEnabled) {
    ...
    private String getTokenInternal() {
		...
		logger.info("[OauthHelperSigmater.getTokenInternal]\n" + 
			        "oauthURL ........: " + oauthURL + "\n" +
