...
public class OauthHelperIndex {

	static String classTag = "INDEX";
	static Logger logger = Logger.getLogger(OauthHelperIndex.class.getCanonicalName());
	...
	public OauthHelperIndex(String oauthURL, String consumerKey, String consumerSecret, int timeout, boolean isTokenCacheEnabled) {
    ...
    private String getTokenInternal() {
		...
		logger.info("[OauthHelperIndex.getTokenInternal]\n" + 
			        "oauthURL ........: " + oauthURL + "\n" +
