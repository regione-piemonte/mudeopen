...
public class OauthHelperLoccsi {

	static String classTag = "LOCCSI";
	static Logger logger = Logger.getLogger(OauthHelperLoccsi.class.getCanonicalName());
	...
	public OauthHelperLoccsi(String oauthURL, String consumerKey, String consumerSecret, int timeout, boolean isTokenCacheEnabled) {
