...
public class OauthHelperToponomastica {

	static String classTag = "LOCCSI";
	static Logger logger = Logger.getLogger(OauthHelperToponomastica.class.getCanonicalName());
	...
	public OauthHelperToponomastica(String oauthURL, String consumerKey, String consumerSecret, int timeout, boolean isTokenCacheEnabled) {
    ...
    private String getTokenInternal() {
		...
		logger.info("[OauthHelperLoccsi.getTokenInternal]\n" + 
			        "oauthURL ........: " + oauthURL + "\n" +
