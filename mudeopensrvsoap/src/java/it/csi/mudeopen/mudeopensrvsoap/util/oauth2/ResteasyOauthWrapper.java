 ...
 * Di fatto si tratta di un proxy di proxy. Il proxy piu' a valle e' un proxy costruito con le client api
...
public class ResteasyOauthWrapper implements InvocationHandler{
	 ...
	 * @param il metodo invocato
	 * @param gli argomenti da passare al metodo 
	 */
