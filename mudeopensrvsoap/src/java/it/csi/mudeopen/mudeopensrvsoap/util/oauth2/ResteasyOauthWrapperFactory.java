...
public class ResteasyOauthWrapperFactory /*extends BaseFactoryBean*/ {
     ...
     *
      ottiene l'interfaccia wrappata del servizio
     */
     ...
     * Create object.
     *
      un oggetto che implementa l'interfaccia <code>wrappedClass</code> e wrappa           l'oggetto <code>port</code>
     ...
     * Gets oauth helper.
     *
      il <code>tokenRetryManager</code> proprietario dell'oggetto <code>port</code>
     */
