...
/**
 * <p>Java class for istanzaEstesa03 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;complexType name="istanzaEstesa03"&gt;
 ...
 *         &lt;element name="tipiTracciatiXML" type="{http://gestionale.interfacews.mudesrvextsic.mude.csi.it/}tracciatoXML" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "istanzaEstesa03", propOrder = {
    "numeroMude",
    "tipoIstanza",
    "speciePratica",
    "tipoIntestatario",
...
public class IstanzaEstesa03 {
    ...
    protected List<TracciatoXML> tipiTracciatiXML;
    ...
    /**
     * Gets the value of the tipiTracciatiXML property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the tipiTracciatiXML property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     *    getTipiTracciatiXML().add(newItem);
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TracciatoXML> getTipiTracciatiXML() {
        if (tipiTracciatiXML == null) {
            tipiTracciatiXML = new ArrayList<TracciatoXML>();
        }
        return this.tipiTracciatiXML;
    }
    /**
