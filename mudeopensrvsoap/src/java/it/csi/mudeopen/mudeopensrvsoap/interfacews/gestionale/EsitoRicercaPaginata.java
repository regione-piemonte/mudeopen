...
/**
 * <p>Java class for esitoRicercaPaginata complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;complexType name="esitoRicercaPaginata"&gt;
 ...
 *         &lt;element name="elencoIstanze" type="{http://gestionale.interfacews.mudesrvextsic.mude.csi.it/}istanzaEstesa" maxOccurs="unbounded" minOccurs="0"/&gt;
 * 
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "esitoRicercaPaginata", propOrder = {
    "listaCompleta",
...
public class EsitoRicercaPaginata {
    ...
    protected List<IstanzaEstesa> elencoIstanze;
    /**
     ...
     * 
     */
    public List<IstanzaEstesa> getElencoIstanze() {
        if (elencoIstanze == null) {
            elencoIstanze = new ArrayList<IstanzaEstesa>();
        }
