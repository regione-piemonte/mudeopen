...
/**
 * <p>Java class for esitoRicercaPaginata02 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * &lt;complexType name="esitoRicercaPaginata02"&gt;
 ...
 *         &lt;element name="elencoIstanze" type="{http://gestionale.interfacews.mudesrvextsic.mude.csi.it/}istanzaEstesa02" maxOccurs="unbounded" minOccurs="0"/&gt;
 * 
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "esitoRicercaPaginata02", propOrder = {
    "listaCompleta",
...
public class EsitoRicercaPaginata02 {
    ...
    protected List<IstanzaEstesa02> elencoIstanze;
    /**
     ...
     * {@link IstanzaEstesa02 }
     * 
     * 
     */
    public List<IstanzaEstesa02> getElencoIstanze() {
        if (elencoIstanze == null) {
            elencoIstanze = new ArrayList<IstanzaEstesa02>();
        }
