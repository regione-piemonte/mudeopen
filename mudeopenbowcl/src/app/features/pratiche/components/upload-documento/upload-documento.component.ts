...
export class UploadDocumentoComponent extends FormUtils implements OnInit {
  ...
  onSubmit() {
    console.log(this.tipoFileForm.value);
  ...
  onFormIOSubmit(submission) {
    //  this.tipoFile = submission.data.tipiDocumento;

    // submission
    console.log(this.file);
    console.log(submission.data);
    this.praticaService
      .uploadAllegato(this.pratica.idPratica, submission.data, this.file)
